 ...
 function subecribeMessageBroker() {
    ...
    window.addEventListener(
        "message",
        (event) => {
         if (event.origin !== "http://localhost:6400" && event.origin !== "http://localhost:4200" && event.origin !== "https://dev.corknote.ru" && event.origin !== "https://corknote.ru" && event.origin !== "https://app.corknote.ru" ) return;
